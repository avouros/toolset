...
% avouros1@sheffield.ac.uk
    ...
    for i = 1:length(varargin)
        % Generic
        if isequal(lower(varargin{i}),'maximize_figure')
            maximize_figure = varargin{i+1};
        elseif isequal(lower(varargin{i}),'overall_figure')
            overall_figure = varargin{i+1};
        elseif isequal(lower(varargin{i}),'visibility')
            visibility = varargin{i+1};
        % Labels    
        elseif isequal(lower(varargin{i}),'Xlabel')
            Xlabel = varargin{i+1};
        elseif isequal(lower(varargin{i}),'Ylabel')
            Ylabel = varargin{i+1};
        elseif isequal(lower(varargin{i}),'Title')
            Title = varargin{i+1};
        elseif isequal(lower(varargin{i}),'tickxl')
            tickxl = varargin{i+1};            
        % Fonts format
        elseif isequal(lower(varargin{i}),'FontSize_ticks')
            FontSize_ticks = varargin{i+1};
        elseif isequal(lower(varargin{i}),'FontSize_labels')
            FontSize_labels = varargin{i+1};
        elseif isequal(lower(varargin{i}),'FontSize_title')
            FontSize_title = varargin{i+1};
        elseif isequal(lower(varargin{i}),'FontWeight_ticks')
            FontWeight_ticks = varargin{i+1}; 
        elseif isequal(lower(varargin{i}),'FontWeight_labels')
            FontWeight_labels = varargin{i+1};
        elseif isequal(lower(varargin{i}),'FontWeight_title')
            FontWeight_title = varargin{i+1};
        elseif isequal(lower(varargin{i}),'FontName')
            FontName = varargin{i+1};             
        % Figure's color aspects
        elseif isequal(lower(varargin{i}),'color_outlier')
            color_outlier = varargin{i+1}; 
        elseif isequal(lower(varargin{i}),'color_median')
            color_median = varargin{i+1};
        elseif isequal(lower(varargin{i}),'color_box')
            color_box = varargin{i+1};
        elseif isequal(lower(varargin{i}),'color_box_outline')
            color_box_outline = varargin{i+1};  
        % Figure's line aspects
        elseif isequal(lower(varargin{i}),'width_bar')
            width_bar = varargin{i+1}; 
        elseif isequal(lower(varargin{i}),'width_outlier')
            width_outlier = varargin{i+1};
        elseif isequal(lower(varargin{i}),'width_median')
            width_median = varargin{i+1};
        elseif isequal(lower(varargin{i}),'width_box_outline')
            width_box_outline = varargin{i+1};         
        elseif isequal(lower(varargin{i}),'width_whiskers')
            width_whiskers = varargin{i+1};         
        % Figure's aesthetics
        elseif isequal(lower(varargin{i}),'symbol_outlier')
            symbol_outlier = varargin{i+1}; 
        elseif isequal(lower(varargin{i}),'inGroupGap')
            inGroupGap = varargin{i+1};
        elseif isequal(lower(varargin{i}),'outGroupGap')
            outGroupGap = varargin{i+1};
        elseif isequal(lower(varargin{i}),'extra_right')
            extra_right = varargin{i+1};         
        elseif isequal(lower(varargin{i}),'extra_left')
            extra_left = varargin{i+1};         
        elseif isequal(lower(varargin{i}),'extra_up')
            extra_up = varargin{i+1};         
        elseif isequal(lower(varargin{i}),'extra_down')
